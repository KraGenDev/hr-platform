...
public class EmployeeApiController {
    ...
    @Operation(summary = "Отримати список посад", description = "Повертає всі доступні посади.")
    @GetMapping("/positions")
    public List<Position> getAllPositions() {
        return positionRepository.findAll();
    }

    @Operation(summary = "Отримати список відділів", description = "Повертає всі доступні відділи.")
    @GetMapping("/departments")
    public List<Department> getAllDepartments() {
        return departmentRepository.findAll();
    }

    // --- Валідація та підстановка пов’язаних об'єктів ---
